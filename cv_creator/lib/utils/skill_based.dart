      ...
      build: (pw.Context context) {
        return pw.Row(
          ...
          children: [
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Row(children: [
                    pw.Icon(pw.IconData(mat.Icons.language.codePoint),
                  ...
                  pw.Row(children: [
                    pw.Icon(pw.IconData(mat.Icons.eco.codePoint),
                        color: PdfColors.white, size: 12),
                    pw.SizedBox(width: 5),
            ...
            // Right column with name, profile, experience, conferences, and courses
            pw.Expanded(
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  ...
                  pw.Row(
                    ...
                    children: [
                      pw.Column(children: [
                        _buildContactInfo(
                            mat.Icons.email, 'frank@novoresume.com'),
                        _buildContactInfo(
                            mat.Icons.phone_android, '123 444 555'),
                      ]),
                      pw.Column(children: [
                        _buildContactInfo(
                            mat.Icons.location_on, 'Montgomery, AL'),
                        _buildContactInfo(mat.Icons.contact_emergency,
                  ...
                  // Experience
                  _buildSectionHeader('WORK EXPERIENCE', PdfColors.black),
                  pw.Bullet(
                    text: 'Sales Associate at ShoPerfect Deluxe Mall\n'
                  ...
                  _buildSectionHeader('CONFERENCES & COURSES', PdfColors.black),
                  pw.Text(
